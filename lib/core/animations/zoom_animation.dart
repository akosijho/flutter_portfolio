...
class _ZoomAnimationState extends State<ZoomAnimation> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _controller2 = AnimationController(vsync: this, duration: const Duration(seconds: 3))..repeat(reverse: true);
    _alignAnimation = Tween<AlignmentGeometry>(begin: Alignment.topCenter, end: Alignment.bottomCenter)
          ...
          child: Container(
            decoration: BoxDecoration(
                ...
                image: const DecorationImage(
                    image: AssetImage(Images.me), fit: BoxFit.cover, alignment: Alignment.bottomLeft)),
          ),
        ),
      ),
    );
